...
#ifndef IGL_PROGRESSIVE_HULLS_COST_AND_PLACEMENT_H
#define IGL_PROGRESSIVE_HULLS_COST_AND_PLACEMENT_H
#include <Eigen/Core>
...
namespace igl
{
  ...
  /// solved via igl::project_to_halfspace_intersection. This function is not
  /// really meant to be called directly but rather passed to `igl::decimate`
  /// as a handle.
  ///
