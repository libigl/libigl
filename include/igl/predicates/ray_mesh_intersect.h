...
#ifndef IGL_PREDICATES_RAY_MESH_INTERSECT_H
#define IGL_PREDICATES_RAY_MESH_INTERSECT_H
...
namespace igl
{
  namespace predicates
  {
    ...
    ///
    /// \see ray_triangle_intersect, igl::ray_mesh_intersect
    template <
    ...
    template <
      ...
      typename DerivedV,
      typename DerivedF>
    IGL_INLINE bool ray_mesh_intersect_all(
      const Eigen::MatrixBase<Derivedsource> & source,
      const Eigen::MatrixBase<Deriveddir> & dir,
      const Eigen::MatrixBase<DerivedV> & V,
      const Eigen::MatrixBase<DerivedF> & F,
