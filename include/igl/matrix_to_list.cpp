...
template void igl::matrix_to_list<Eigen::Matrix<int64_t, -1, 8, 1, -1, 8>>(Eigen::MatrixBase<Eigen::Matrix<int64_t, -1, 8, 1, -1, 8>> const&, std::vector<Eigen::Matrix<int64_t, -1, 8, 1, -1, 8>::Scalar, std::allocator<Eigen::Matrix<int64_t, -1, 8, 1, -1, 8>::Scalar>>&);
