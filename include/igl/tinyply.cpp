...
namespace igl::tinyply {
  ...
  struct PlyFile::PlyFileImpl
  {
      ...
      IGL_INLINE void parse_data(std::istream & is, bool firstPass);
      IGL_INLINE void read_header_format(std::istream & is);
      IGL_INLINE void read_header_element(std::istream & is);
      IGL_INLINE void read_header_property(std::istream & is);
      IGL_INLINE void read_header_text(std::string line, std::istream & is, std::vector<std::string> & place, int erase = 0);
  
      IGL_INLINE void write_header(std::ostream & os);
      IGL_INLINE void write_ascii_internal(std::ostream & os);
      IGL_INLINE void write_binary_internal(std::ostream & os);
      IGL_INLINE void write_property_ascii(Type t, std::ostream & os, uint8_t * src, size_t & srcOffset);
      IGL_INLINE void write_property_binary(Type t, std::ostream & os, uint8_t * src, size_t & srcOffset, const size_t & stride);
  };
  ...
  IGL_INLINE void PlyFile::PlyFileImpl::read_header_text(std::string line, std::istream & is, std::vector<std::string>& place, int erase)
  {
  ...
  IGL_INLINE size_t PlyFile::PlyFileImpl::read_property_binary(const Type & t, const size_t & stride, void * dest, size_t & destOffset, std::istream & is)
  {
      destOffset += stride;
  ...
  IGL_INLINE void PlyFile::PlyFileImpl::write_property_binary(Type t, std::ostream & os, uint8_t * src, size_t & srcOffset, const size_t & stride)
  {
  ...
  IGL_INLINE void PlyFile::PlyFileImpl::write_binary_internal(std::ostream & os)
  {
      isBinary = true;
      write_header(os);
