...
#ifndef IGL_VIRIDIS_H
#define IGL_VIRIDIS_H
#include "igl_inline.h"

#include <Eigen/Dense>

namespace igl {
  // Viridis colormap -- a perceptually uniform sequential colormap
  //
  // Inputs:
  //   m  number of colors 
  // Outputs:
  ...
  //   b  blue value
  template <typename T>
  IGL_INLINE void viridis(const T f, T * rgb);
  template <typename T>
  IGL_INLINE void viridis(const T f, T & r, T & g, T & b);
  // Inputs:
  //   Z  #Z list of factors
