...
template void igl::sort<int64_t>(std::vector<int64_t, std::allocator<int64_t>> const&, bool, std::vector<int64_t, std::allocator<int64_t>>&, std::vector<size_t, std::allocator<size_t>>&);
