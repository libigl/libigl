...
template bool igl::list_to_matrix<int64_t, Eigen::Matrix<int64_t, -1, 1, 0, -1, 1>>(std::vector<int64_t, std::allocator<int64_t>> const&, Eigen::PlainObjectBase<Eigen::Matrix<int64_t, -1, 1, 0, -1, 1>>&);
