...
function(check_subproject_dirs project)
    if(NOT ${project}_SOURCE_DIR)
      message(FATAL_ERROR
          "'${project}_SOURCE_DIR' must be specified. It should be populated by FetchContent when "
          "the specific version of ${project} is acquired by the libigl build. Received "
...
function(create_use_libigl_test)
    ...
    if(NOT DEFINED ARGS_IGL_TARGET)
        message(FATAL_ERROR
            "The argument 'IGL_TARGET' must be provided to ${CMAKE_CURRENT_FUNCTION}")
    endif()
