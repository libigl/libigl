...
TEST_CASE("writeMSH", "[igl]") {
  ...
  REQUIRE(igl::readMSH("test_binary_sphere_2.msh", _X, _Tri, _Tet, _TriTag,
                       _TetTag, _XFields, _XF, _EFields, _TriF, _TetF));
