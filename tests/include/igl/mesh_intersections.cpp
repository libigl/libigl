...
TEST_CASE("tri_tri_intersection_test_3d intersect", "[igl]")
{
  ...
  Eigen::Vector3d p1(0,0,0),q1(1,0,0),r1(0,1,0);
  Eigen::Vector3d p2(0,0,1),q2(1,1,0),r2(0,0,-1);
  ...
  if(s.norm()<1e-5)
  {
    Eigen::Vector3d t_correct(0.5,0.5,0);
    Eigen::Vector3d s_correct(0,0,0);
    test_common::assert_near( t, t_correct, 1e-10);
    test_common::assert_near( s, s_correct, 1e-10);
  } else {
    Eigen::Vector3d s_correct(0.5,0.5,0);
    Eigen::Vector3d t_correct(0,0,0);
    test_common::assert_near( t, t_correct, 1e-10);
    test_common::assert_near( s, s_correct, 1e-10);
  }
}
...
TEST_CASE("tri_tri_intersection_test_3d not intersect", "[igl]")
{
  // positive test that two triangles intersect
  Eigen::Vector3d p1(0,0,0),q1(1,0,0),r1(0,1,0);
  Eigen::Vector3d p2(0,0,1),q2(1,0,1),r2(0,1,1);
...
TEST_CASE("tri_tri_intersection_test_3d coplanar", "[igl]")
{
  // positive test that two triangles intersect
  Eigen::Vector3d p1(0,0,0),q1(1,0,0),r1(0,1,0);
  Eigen::Vector3d p2(0,0,0),q2(0.5,0,0),r2(0,0.5,0);
