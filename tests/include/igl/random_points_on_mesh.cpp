...
namespace random_points_on_mesh
{
  ...
  void test_reproduce()
  {
    ...
    Eigen::MatrixXd P1, Px1;
    {
      ...
      Eigen::VectorXi I;
      URBG rng1(seed);
      igl::random_points_on_mesh(rng1,n,V,F,B,I,P1);
      igl::random_points_on_mesh(rng1,n,V,F,B,I,Px1);
    }
    Eigen::MatrixXd P2, Px2;
    {
      ...
      Eigen::VectorXi I;
      URBG rng2(seed);
      igl::random_points_on_mesh(rng2,n,V,F,B,I,P2);
      igl::random_points_on_mesh(rng2,n,V,F,B,I,Px2);
    }
...
TEST_CASE("random_points_on_mesh: ranlux24_base_reproduce", "[igl]")
{
  random_points_on_mesh::test_reproduce<std::ranlux24_base>();
}
TEST_CASE("random_points_on_mesh: ranlux48_base_reproduce", "[igl]")
{
  random_points_on_mesh::test_reproduce<std::ranlux48_base>();
}
TEST_CASE("random_points_on_mesh: ranlux24_reproduce", "[igl]")
{
  random_points_on_mesh::test_reproduce<std::ranlux24>();
}
TEST_CASE("random_points_on_mesh: ranlux48_reproduce", "[igl]")
{
  random_points_on_mesh::test_reproduce<std::ranlux48>();
}
TEST_CASE("random_points_on_mesh: knuth_b_reproduce", "[igl]")
{
  random_points_on_mesh::test_reproduce<std::knuth_b>();
}
