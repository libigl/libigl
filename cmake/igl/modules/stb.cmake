...
if(LIBIGL_OPENGL)
  message(STATUS "Including opengl/image support")
  file(GLOB OPENGL_INC_FILES "${libigl_SOURCE_DIR}/include/igl/opengl/image/*.h")
  file(GLOB OPENGL_SRC_FILES "${libigl_SOURCE_DIR}/include/igl/opengl/image/*.cpp")
