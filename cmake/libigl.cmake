...
if(LIBIGL_WITH_EMBREE)
  ...
  if(NOT TARGET embree)
    ...
    # EMBREE_STATIC_LIB can only be used with a single ISA target. Use AVX2 by
    # default (i.e., assume most igl_embree users will have avx2 support)
    set(EMBREE_ISA_SSE2 OFF CACHE STRING " ")
    set(EMBREE_ISA_SSE42 OFF CACHE STRING " ")
    set(EMBREE_ISA_AVX OFF CACHE STRING " ")
    set(EMBREE_ISA_AVX2 ON CACHE STRING " ")
    set(EMBREE_ISA_AVX512KNL OFF CACHE STRING " ")
    set(EMBREE_ISA_AVX512SKX OFF CACHE STRING " ")
    if(MSVC)
