...
option(LIBIGL_WITH_STB               "Use STB library"              OFF)
...
if(LIBIGL_WITH_STB)
  ...
  compile_igl_module("stb" "")
  target_link_libraries(igl_stb ${IGL_SCOPE} igl_stb_image )
  
  if(TARGET igl_opengl)
    compile_igl_module("opengl/image" "")
    target_link_libraries(igl_opengl_image ${IGL_SCOPE} igl_stb igl_opengl) 
  endif()
endif()
