...
if(LIBIGL_WITH_OPENGL_GLFW_IMGUI)
  if(TARGET igl::opengl_glfw)
    ...
    if(NOT TARGET imgui)
      ...
      add_library(igl_opengl_glfw_imguizmo ${LIBIGL_EXTERNAL}/imguizmo/ImGuizmo.cpp ${LIBIGL_EXTERNAL}/imguizmo/ImGuizmo.h)
      # target_include_directories(igl_opengl_glfw_imguizmo PUBLIC ${LIBIGL_EXTERNAL}/imgui)
      add_library(igl::opengl_glfw_imguizmo ALIAS igl_opengl_glfw_imguizmo)
    endif()
    target_link_libraries(igl_opengl_glfw_imgui ${IGL_SCOPE} igl_opengl_glfw imgui)
    target_link_libraries(igl_opengl_glfw_imguizmo PUBLIC imgui)
    target_link_libraries(igl_opengl_glfw_imguizmo ${IGL_SCOPE} imguizmo)
  endif()
endif()
