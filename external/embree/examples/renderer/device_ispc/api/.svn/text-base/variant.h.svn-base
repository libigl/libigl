...
#ifndef __EMBREE_ISPC_VARIANT_H__
#define __EMBREE_ISPC_VARIANT_H__
...
namespace embree
{
  ...
  public:
    ...
    /*! Constructs a variant object holding an image or texture reference. */
    Variant (Type ty, ISPCRef& ptr) : type(ty), ptr(ptr) {}
    ...
    ISPCRef getImage  () const { return ptr; }

    /*! Extracts a texture reference from the variant type. */
    ISPCRef getTexture() const { return ptr; }
  ...
  public:
    ...
    ISPCRef ptr;          //!< Reference to ISPC managed object
  };
}
