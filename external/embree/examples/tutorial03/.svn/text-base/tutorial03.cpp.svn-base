...
namespace embree
{
  ...
  /* scene */
  static OBJMesh g_mesh;
  static Vec3f g_pointLightPosition = Vec3f(0,0,0);
  static Vec3f g_pointLightIntensity = Vec3f(0,0,0);
  static Vec3f g_ambientLightIntensity = Vec3f(1.0,1.0,1.0);
