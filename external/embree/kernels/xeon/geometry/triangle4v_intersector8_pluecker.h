...
#ifndef __EMBREE_ACCEL_TRIANGLE4V_INTERSECTOR8_PLUECKER_H__
#define __EMBREE_ACCEL_TRIANGLE4V_INTERSECTOR8_PLUECKER_H__
...
namespace embree
{
  struct Triangle4vIntersector8Pluecker
  {
    ...
    static __forceinline void intersect(const avxb& valid, Ray8& ray, const Triangle4v* tri, size_t num, void* geom)
    {
    ...
    static __forceinline avxb occluded(const avxb& valid_i, Ray8& ray, const Triangle4v& tri, void* geom)
    {
      avxb valid0 = valid_i;
    ...
    static __forceinline avxb occluded(const avxb& valid, Ray8& ray, const Triangle4v* tri, size_t num, void* geom)
    {
      avxb valid0 = valid;
      for (size_t i=0; i<num; i++) {
    ...
    static __forceinline void intersect(Ray8& ray, size_t k, const Triangle4v& tri, void* geom)
    {
      /* calculate vertices relative to ray origin */
    ...
    static __forceinline void intersect(Ray8& ray, size_t k, const Triangle4v* tri, size_t num, void* geom)
    {
      for (size_t i=0; i<num; i++)
    ...
    static __forceinline bool occluded(Ray8& ray, size_t k, const Triangle4v& tri, void* geom)
    {
      /* calculate vertices relative to ray origin */
    ...
    static __forceinline bool occluded(Ray8& ray, size_t k, const Triangle4v* tri, size_t num, void* geom) 
    {
      for (size_t i=0; i<num; i++) 
