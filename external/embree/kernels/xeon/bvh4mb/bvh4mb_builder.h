...
namespace embree
{
  ...
  public:
    ...
    /*! Constructor. */
    BVH4MBBuilder(BVH4MB* bvh, BuildSource* source, void* geometry, const size_t minLeafSize = 1, const size_t maxLeafSize = inf);

    /*! Destructor. */
    ~BVH4MBBuilder();

    /*! build job */
    TASK_COMPLETE_FUNCTION(BVH4MBBuilder,buildFunction);
  ...
  private:
    ...
    const PrimitiveType& trity;          //!< triangle type stored in BVH
