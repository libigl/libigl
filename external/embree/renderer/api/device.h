  ...
  *******************************************************************/
  ...
  public:
    ...
    *******************************************************************/
    ...
    virtual RTImage rtNewImage(const char* type, size_t width, size_t height, const void* data) = 0;
     ...
     *  transformation to transform the shape \returns primitive
     *  handle */
    virtual RTPrimitive rtNewLightPrimitive(RTLight light, const float* transform = NULL) = 0;
     ...
     *  scene handle */
    virtual RTScene rtNewScene(const char* type, RTPrimitive* prims, size_t size) = 0;
     ...
     *  handle */
    virtual RTFrameBuffer rtNewFrameBuffer(const char* type, size_t width, size_t height, size_t buffers = 1) = 0;

    /*! Returns the size of the framebuffer. */
    virtual void rtGetFrameBufferSize(RTFrameBuffer frameBuffer, size_t& width, size_t& height) = 0;

    /*! Map the framebuffer data. \param frameBuffer is the framebuffer
     *  to map \returns pointer to framebuffer data */
    virtual void* rtMapFrameBuffer(RTFrameBuffer frameBuffer) = 0;

    /*! Unmap the framebuffer data. \param frameBuffer is the
     *  framebuffer to unmap. */
    virtual void rtUnmapFrameBuffer(RTFrameBuffer frameBuffer) = 0;
