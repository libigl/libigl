...
#ifndef __EMBREE_BVH2_INTERSECTOR1_H__
#define __EMBREE_BVH2_INTERSECTOR1_H__
...
namespace embree
{
  ...
  class BVH2Intersector1 : public Intersector1
  {
  ...
  public:
    ...
    BVH2Intersector1 (const BVH2* bvh) 
      : Intersector1((intersectFunc)intersect,(occludedFunc)occluded), bvh(bvh) {}

    static Intersector1* create(const Accel* bvh) { 
      return new BVH2Intersector1((const BVH2*)bvh); 
    }

    static void intersect(const BVH2Intersector1* This, Ray& ray);
    static bool occluded (const BVH2Intersector1* This, Ray& ray);
