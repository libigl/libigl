...
#ifndef __EMBREE_BVH4_INTERSECTOR1_AVX_H__
#define __EMBREE_BVH4_INTERSECTOR1_AVX_H__
...
namespace embree
{
  ...
  class BVH4Intersector1AVX : public Intersector1
  {
  ...
  public:
    BVH4Intersector1AVX (const BVH4* bvh) 
      : Intersector1((intersectFunc)intersect,(occludedFunc)occluded), bvh(bvh) {}

    static Intersector1* create(const Accel* bvh) { 
      return new BVH4Intersector1AVX((const BVH4*)bvh); 
    }

    static void intersect(const BVH4Intersector1AVX* This, Ray& ray);
    static bool occluded (const BVH4Intersector1AVX* This, Ray& ray);
