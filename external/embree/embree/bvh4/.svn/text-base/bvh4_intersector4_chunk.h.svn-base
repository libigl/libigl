...
namespace embree
{
  ...
  template<typename TriangleIntersector>
    class BVH4Intersector4Chunk : public Intersector4
  {
  ...
  public:
    BVH4Intersector4Chunk (const BVH4* bvh) 
      : Intersector4((intersectFunc)intersect,(occludedFunc)occluded), bvh(bvh) {}

    static Intersector4* create(const Accel* bvh) { 
      return new BVH4Intersector4Chunk((const BVH4*)bvh); 
    }

    static   void intersect(const BVH4Intersector4Chunk* This, Ray4& ray, const __m128 valid);
    static __m128 occluded (const BVH4Intersector4Chunk* This, Ray4& ray, const __m128 valid);
