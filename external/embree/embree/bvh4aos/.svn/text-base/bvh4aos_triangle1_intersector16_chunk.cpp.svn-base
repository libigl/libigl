...
#include "bvh4aos_triangle1_intersector16_chunk.h"
#include "../geometry/triangles.h"

namespace embree
{
  void BVH4AOSTriangle1Intersector16Chunk::intersect(const BVH4AOSTriangle1Intersector16Chunk* This, Ray16& ray, const __mmask valid_i)
  {
...
#pragma unroll(4)
  ...
  __mmask BVH4AOSTriangle1Intersector16Chunk::occluded(const BVH4AOSTriangle1Intersector16Chunk* This, Ray16& ray, const __mmask valid_i)
  {
    /* pointers to node array and triangle array */
    const mic_m valid = valid_i;
    const BVH4AOS* bvh = This->bvh;
    ...
    while (1)
    {
      ...
      while (1)
      {
        ...
        sptr_node--;
        sptr_near--;
        const Node* const node = (Node*)((char*)nodes + (unsigned long)curNode);
        prefetch<PFHINT_L1>((mic_f*)node + 1); // depth first order prefetch		
        curNode = *sptr_node;
        minDist = *sptr_near;
...
#pragma unroll(4)
  ...
  {
    TriangleMesh::intersectors16.add("bvh4aos","triangle1","chunk_inlined","moeller",true ,BVH4AOSTriangle1Intersector16Chunk::create);
  }
}
