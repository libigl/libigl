...
namespace embree
{
  void BVH4AOSTriangle1Intersector1::intersect(const BVH4AOSTriangle1Intersector1* This, Ray& ray)
  {
    ...
    const Triangle1* const __restrict__ triangles = (const Triangle1*) bvh->triPtr();
  ...
  bool BVH4AOSTriangle1Intersector1::occluded(const BVH4AOSTriangle1Intersector1* This, Ray& ray)
  {
    /* pointers to node array and triangle array */
    const BVH4AOS* bvh = This->bvh;
    const Node*       const __restrict__ nodes     = (const Node*      ) bvh->nodePtr();
  ...
  {
    TriangleMesh::intersectors1.add("bvh4aos","triangle1","fast_inlined","moeller",true ,BVH4AOSTriangle1Intersector1::create);
    TriangleMesh::intersectors1.setAccelDefaultTraverser("bvh4aos","fast_inlined");
  }
}
